...
public class Pomodoro {
   ...
   @FXML
   private Spinner<Integer> tomatoMinutes;
   @FXML
   private Text finishedTomatoesTitle;
   @FXML
   private VBox finishedTomatoes;
   ...
   protected void initialize() {
      ...
      if (readObj instanceof ArrayList<?> && ((ArrayList<?>) readObj).size() > 0
   ...
   /**
    * Event handler for starting a new tomato. Handles updating timer as time
    * passes.
    * 
    * @author Egan Dunning
    *
   ...
   /**
    * Runs when a tomato is finished. Cancels timer and prompts user for a
    * description of what they accomplished during the tomato. Plays an audio clip
    * of a bell noise.
    */
   ...
   /**
    * This runs when the user ends a tomato, then submits a description of what
    * they did during that tomato. Adds description of task to list, then starts 5
    * minute break. Increments finished tomato counter.
    */
   @FXML
   ...
   /**
    * TimerTask for handling updating time display, bell notification and action to
    * take at the end of breaks, tomatoes.
    * 
    * @author Egan Dunning
    */
