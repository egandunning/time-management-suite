...
public class ListItemElement {
    ...
    /**
     * Return the time from now until the given deadline in a readable string. For
     * example: "8 days and 1 hour"
     * 
     * @param deadline
     *            The deadline to get time until.
	...
	if (hours > 24) {
	    ...
	    return String.format("%d day%s, %d hour%s", days, dayPlural, hours, hourPlural);// days + " day" + dayPlural
											    // + ", " + hours + " hour"
											    // + hourPlural;
	} else {
