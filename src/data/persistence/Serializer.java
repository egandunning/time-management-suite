...
public class Serializer {
	...
	/**
	 * Writes an object to specified file. If overwrite parameter is true,
	 * any existing file with the same filename is overwritten. Files are saved
	 * in a directory called data.
	 * @param obj The object to write to file.
	 * @param filename the filename to write the object to.
	 * @param overwrite a flag to determine if an existing file should be
	 * overwritten. True causes existing files to be overwritten.
	...
	/**
	 * Writes an object to specified file. Any existing file with the same
	 * filename is overwritten. Files are saved in a directory called data.
	 * @param obj The object to write to file.
	 * @param filename the filename to write the object to.
	 * @return true if the object was written to file
	 */
